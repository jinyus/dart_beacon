...
void main(List<String> args) {
  ...
  // final firstArg = args.isNotEmpty
  //     ? args[0]
  //     : () {
  //         print(
  //             'Please provide a test argument: observer, derived, effect, graph');
  //         exit(1);
  //       }();

  // print('Running performance tests with argument: $firstArg\n');

  // if (firstArg == 'observer') {
  //   return ObserverNotificationBenchmark().report();
  // }

  // if (firstArg == 'derived') {
  //   return DerivedBeaconUpdateBenchmark().report();
  // }

  // if (firstArg == 'effect') {
  //   return EffectExecutionBenchmark().report();
  // }

  // if (firstArg == 'graph') {
  //   return LargeDependencyGraphBenchmark().report();
  // }

  // print('Unknown test argument: $firstArg');
}
